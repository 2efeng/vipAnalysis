package com.hzf.database;

import com.hzf.bean.Chek;
...
public class AllMethod {
    ...
    public Chek CheckLogin(User user) throws Exception {
        //判断账号密码登录方法
    ...
    */
    public void Add(User users) {
        ...
        try {
            ...
            ps.setString(4, users.getRemarks());
            //执行查询。
            ps.executeUpdate();
            //关闭查询
    ...
    public User findOneAll(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                user.setRemarks(rs.getString("beizhu"));
            }
